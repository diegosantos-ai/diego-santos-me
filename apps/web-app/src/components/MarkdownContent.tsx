  ...
  useEffect(() => {
    ...
    async function renderMermaidDiagrams() {
      ...
      mermaid.initialize({
        ...
        theme: 'base',
        themeVariables: {
          background: rootStyles.getPropertyValue('--bg-elevated').trim() || '#091220',
          primaryColor: rootStyles.getPropertyValue('--bg-secondary').trim() || '#002642',
          primaryTextColor: rootStyles.getPropertyValue('--text-primary').trim() || '#f4eeee',
          primaryBorderColor: rootStyles.getPropertyValue('--accent-amber').trim() || '#e59500',
          lineColor: rootStyles.getPropertyValue('--accent-bronze').trim() || '#cb5b00',
          secondaryColor: rootStyles.getPropertyValue('--bg-primary').trim() || '#02040f',
          tertiaryColor: rootStyles.getPropertyValue('--bg-secondary').trim() || '#002642',
